...
export function buildRemoteGamifiedState(
  ...
  return {
    coopGuard: {
      ...
      explanation:
        'Esta funcionalidade requer conexão externa (WebSocket) para multiplayer real. A interface local está pronta para integração futura.',
    },
    deathPenalty: {
      ...
      consequence:
        'Se ativado, falhas consecutivas afetam a arte do Dashboard, sem apagar seu histórico ou prejudicar métricas reais.',
    },
    roguelike: {
