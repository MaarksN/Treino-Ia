...
const CHALLENGES_POOL: WeeklyChallenge[] = [
  {
    id: 'w1',
    title: 'O Retorno Jedi',
    description: 'Complete 3 treinos nesta semana para construir consistência.',
    target: 3,
    unit: 'treinos',
  },
  {
    id: 'w2',
    title: 'Volume Insano',
    description: 'Acumule 10.000 kg de volume total nesta semana.',
    target: 10000,
    unit: 'kg',
  },
  {
    ...
    description:
      'Não modifique a técnica sugerida pela IA em nenhum exercício por 2 treinos seguidos.',
    target: 2,
    unit: 'treinos',
  },
  {
    id: 'w4',
    title: 'Descanso de Campeão',
    description: 'Respeite todos os tempos de descanso cronometrados.',
    target: 100,
    unit: '%',
  },
];
...
export function calculateLocalChallengeProgress(
