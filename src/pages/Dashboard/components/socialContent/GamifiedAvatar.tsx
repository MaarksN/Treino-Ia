...
export const GamifiedAvatar = memo(function GamifiedAvatar({ level }: GamifiedAvatarProps) {
  ...
  return (
    <div
      ...
      aria-hidden="true"
      title="Avatar gamificado ilustrativo (sem fins médicos/físicos exatos)"
    >
      <svg
        width="80"
        height="80"
      ...
      >
        ...
        <path
          d="M50 30 Q60 50 50 70 Q40 50 50 30"
          fill={colors[Math.min(rings - 1, colors.length - 1)]}
          opacity="0.8"
        />
      ...
      <span className="mt-1 text-[8px] text-brand-muted max-w-[80px] text-center leading-tight">
        Ilustrativo
      </span>
    </div>
  );
