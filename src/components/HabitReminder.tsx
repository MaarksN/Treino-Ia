  ...
  return (
    <div className="bg-brand-gray border-2 border-brand-light/10 p-5 shadow-brutal-light">
      <div className="flex items-center justify-between mb-4">
        ...
        {config.enabled ? (
          <Bell size={20} className="text-brand-neon" />
        ) : (
          <BellOff size={20} className="text-brand-muted" />
        )}
      </div>
      ...
      {notifStatus !== 'granted' && (
        <button
          ...
          type="button"
          className="w-full bg-brand-neon text-brand-dark font-black py-3 border-brutal uppercase tracking-widest mb-4"
        >
          Ativar notificações
        </button>
      )}
      ...
      {notifStatus === 'denied' && (
        <p className="text-red-400 text-sm mb-4">Notificações bloqueadas no navegador.</p>
      )}
      ...
      {notifStatus === 'granted' && (
        <button
          ...
          type="button"
          className="w-full bg-brand-dark border-2 border-brand-light/10 text-brand-light py-2 text-sm hover:border-brand-neon transition-colors"
        >
