  ...
  APP_THEMES: [
    {
      ...
      isPremium: false,
      emoji: '☀️',
      vars: { '--color-brand-dark': '#fff', '--color-brand-neon': '#000' },
    },
    {
      id: 'dark-pro',
      name: 'Dark Pro',
      ...
      isPremium: true,
      emoji: '🌙',
      vars: { '--color-brand-dark': '#000', '--color-brand-neon': '#fff' },
    },
  ],
  applyTheme: vi.fn(),
...
describe('ThemeSelector', () => {
  ...
  it('renders available themes', () => {
    vi.mocked(themeUtils.getThemeAccess).mockReturnValue({
      allowed: true,
      theme: themeUtils.APP_THEMES[0],
    });
  ...
  it('calls applyTheme and onThemeChange when a theme is selected', () => {
    ...
    vi.mocked(themeUtils.applyTheme).mockReturnValue({
      allowed: true,
      applied: true,
      theme: themeUtils.APP_THEMES[0],
    });
    ...
    expect(themeUtils.applyTheme).toHaveBeenCalledWith('dark-pro', {
      enforcePremium: true,
      isPremium: true,
    });
