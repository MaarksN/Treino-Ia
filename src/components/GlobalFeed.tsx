  ...
  return (
    <div className="max-w-3xl mx-auto p-4 md:p-8 mt-8">
      <div className="flex items-center mb-8 border-b-4 border-brand-neon pb-4">
        ...
        <div>
          <h1 className="font-display font-black text-6xl tracking-tighter uppercase text-brand-light text-shadow-neon">
            Arena Global
          </h1>
          <p className="text-brand-magenta font-mono font-bold">
            Atletas ao redor do mundo esculpindo resultados reais.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        {FAKE_POSTS.map((post) => {
          ...
          return (
            <div
              key={post.id}
              className="bg-brand-gray border-2 border-brand-light/20 p-6 shadow-[4px_4px_0px_rgba(255,255,255,0.1)] hover:border-brand-neon transition-colors"
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                  <img
                    ...
                    alt={post.user.name}
                    className="w-12 h-12 border-2 border-brand-neon object-cover"
                  />
                  <div>
              ...
              <div className="mb-4">
                <p className="text-brand-light text-lg">
                  ...
                  <span className="font-display text-2xl font-black text-brand-neon tracking-wider">
                    {post.workoutName}
                  </span>
                </p>
