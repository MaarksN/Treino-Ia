      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative z-10 w-full items-center">
        ...
        <div className="flex items-center gap-6 border-r-0 md:border-r-2 border-brand-light/10 pr-4">
          <div>
            ...
            <p className="text-brand-muted font-mono text-[10px] uppercase tracking-widest mt-1">
        ...
        <div className="flex flex-col justify-center border-r-0 md:border-r-2 border-brand-light/10 pr-4">
          ...
          <p className="text-[10px] font-mono text-brand-muted uppercase text-right w-full">
            {g.xp} XP Totais
          </p>
        </div>
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex gap-2">
            {g.badges && g.badges.length > 0 ? (
              g.badges.slice(0, 3).map((b, i) => (
                <div
                  key={i}
                  className="w-10 h-10 rounded-full bg-brand-neon/20 border border-brand-neon flex items-center justify-center text-brand-neon font-bold text-xs"
                  title={b}
                >
                  🏆
                </div>
              ...
              <span className="text-xs text-brand-muted uppercase font-mono">
                Destrua treinos para ganhar emblemas
              </span>
            )}
          </div>
        </div>
