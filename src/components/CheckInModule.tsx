    ...
    <div className="glass-panel-neon p-6 md:p-8 rounded-[28px] mb-12 relative overflow-hidden group transition-all duration-500 hover:shadow-[0_0_40px_rgba(25,167,255,0.15)]">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 relative z-10">
        <div className="flex-1">
          ...
          <h3 className="font-display font-black text-4xl md:text-5xl uppercase text-brand-light mb-3 tracking-tighter">
            Check-in de Fibras
          </h3>
          <p className="text-brand-muted font-mono text-sm max-w-lg mb-4">
            Sua academia é o seu templo. Registre seu local e cronometre o seu massacre diário
            contra as desculpas.
          </p>
          <div className="flex items-center gap-3">
            ...
            {statusMsg && (
              <div className="text-brand-magenta flex-1 font-mono text-[10px] font-bold uppercase animate-pulse">
                {statusMsg}
              </div>
            )}
          </div>
              ...
              {location ? (
                <div className="flex items-center text-xs text-brand-light bg-brand-dark/50 border border-brand-light/10 rounded-full px-4 py-2 font-mono uppercase w-full justify-center backdrop-blur-md">
                  ...
                  <span className="truncate">
                    L: {location.lat.toFixed(3)}, L: {location.lng.toFixed(3)}
                  </span>
                </div>
              ) : (
