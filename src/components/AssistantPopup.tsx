...
const MESSAGES = [
  {
    icon: Droplet,
    title: 'HIDRATAÇÃO SISTÊMICA',
    text: '💧 Você bebeu água na última hora? Seus músculos precisam de H2O para sintetizar proteína. Beba agora.',
    color: 'text-brand-light',
    border: 'border-brand-light',
  },
  {
    icon: BrainCircuit,
    title: 'UPGRADE NEURAL',
    text: '🧠 Você sabia? A fase excêntrica (descida) causa mais microlesões musculares que a concêntrica. Controle a descida.',
  ...
  },
  {
    icon: Zap,
    title: 'NOVO HÁBITO',
    text: '⚡ Tente adicionar 5 minutos de mobilidade antes do treino. Articulações lubrificadas igualam a mais carga e menos lesões.',
    color: 'text-brand-neon',
    border: 'border-brand-neon',
  },
  {
    icon: Droplet,
    title: 'STATUS DE FLUIDOS',
    text: '🌊 Beba 500ml de água 2 horas antes de esmagar seus músculos para garantir um pump máximo e resistência.',
    color: 'text-brand-light',
    border: 'border-brand-light',
  },
  {
    icon: Activity,
    title: 'HACK DE RECUPERAÇÃO',
    text: '🔋 Dormir menos de 7 horas reduz sua síntese proteica. O sono é onde seus músculos crescem, não na academia.',
    color: 'text-brand-magenta',
    border: 'border-brand-magenta',
  },
];
      ...
      {currentMsgIndex !== null && (
        ...
        >
          ...
          <div className="flex items-start mt-2">
            ...
            <div>
              <h4
                className={`font-display font-black tracking-widest uppercase mb-1 ${MESSAGES[currentMsgIndex].color} text-lg`}
              >
