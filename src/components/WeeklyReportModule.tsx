  ...
  useEffect(() => {
    ...
    const fetchReport = async () => {
      try {
        ...
        if (mounted)
          setReport('Erro ao gerar relatório com a IA. Recarregue os sistemas de inteligência.');
      } finally {
          ...
          <div className="bg-black/50 border border-brand-neon/30 p-6 rounded-2xl mb-8">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center py-8">
                ...
                <p className="font-mono text-sm uppercase tracking-widest text-brand-neon/80">
                  Processando dados na forja neural...
                </p>
              </div>
            ) : (
