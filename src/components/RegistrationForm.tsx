  ...
  return (
    <div className="max-w-md mx-auto p-6 md:p-8 mt-12 bg-brand-gray border-4 border-brand-neon shadow-brutal-neon">
      <div className="text-center mb-10">
        <label className="cursor-pointer inline-block group mb-8">
          {avatar ? (
            <img
              src={avatar}
              alt="Avatar"
              className="w-28 h-28 object-cover rounded-full border-4 border-brand-neon mx-auto hover:brightness-110 transition-all shadow-[0_0_20px_var(--color-brand-neon)]"
            />
          ) : (
            <div className="relative inline-flex items-center justify-center w-28 h-28 rounded-full bg-brand-neon text-brand-dark border-brutal group-hover:bg-brand-light transition-colors shadow-[0_0_20px_var(--color-brand-neon)]">
              ...
              <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full text-[10px] font-black uppercase text-brand-light bg-brand-magenta whitespace-nowrap shadow-md z-10">
                Adicionar Foto
              </div>
            </div>
          )}
        ...
        <h1 className="font-display font-black text-6xl sm:text-7xl tracking-normal uppercase text-brand-light mb-2 text-shadow-neon text-stroke-black leading-none">
          INICIAR
        </h1>
        <p className="text-brand-magenta font-mono font-bold text-sm">
          Crie seu perfil para montar seu plano e começar o treino de hoje.
        </p>
      </div>
