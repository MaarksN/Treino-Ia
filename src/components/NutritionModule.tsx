...
export function NutritionModule({ profile }: Props) {
  ...
  const activityMultiplier =
    profile.daysPerWeek >= 5 ? 1.55 : profile.daysPerWeek >= 3 ? 1.375 : 1.2;
  ...
  return (
    <div className="bg-brand-dark border-4 border-brand-light p-6 mt-8 relative shadow-brutal-light flex flex-col md:flex-row items-center gap-8 group hover:border-brand-neon transition-colors">
      ...
      <div className="flex-shrink-0 text-center flex flex-col items-center">
        ...
        <span className="font-display font-black text-3xl group-hover:text-brand-neon transition-colors leading-none">
          {targetCalories}
        </span>
        <span className="font-mono text-[10px] font-bold text-brand-muted uppercase tracking-widest mt-1">
          KCAL / DIA
        </span>
      </div>
      ...
      <div className="flex-1 grid grid-cols-3 gap-2 w-full text-center">
        <div className="p-2 border-2 border-brand-light/10 flex flex-col">
          ...
          <span className="text-[10px] font-mono text-brand-neon font-bold uppercase tracking-widest mt-1">
            Proteína
          </span>
        ...
        <div className="p-2 border-2 border-brand-light/10 flex flex-col">
          ...
          <span className="text-[10px] font-mono text-brand-magenta font-bold uppercase tracking-widest mt-1">
            Carboidrato
          </span>
        ...
        <div className="p-2 border-2 border-brand-light/10 flex flex-col">
          ...
          <span className="text-[10px] font-mono text-[#D4AF37] font-bold uppercase tracking-widest mt-1">
            Gordura
          </span>
      ...
      <div className="flex-shrink-0 text-right md:w-48">
        <h4 className="font-display text-lg uppercase font-bold text-brand-light flex items-center justify-end">
          <Apple className="w-4 h-4 mr-2 text-brand-light" /> IA Macro-Forge
        </h4>
        <p className="text-[10px] text-brand-muted font-mono mt-1 leading-relaxed text-right mb-4">
          Cálculo estimado para <span className="text-brand-light">{profile.goal}</span>. Bata as
          proteínas. O resto é detalhe.
        </p>
        ...
        <div className="absolute top-full left-0 right-0 mt-4 bg-brand-dark border-2 border-[#D4AF37] p-6 shadow-[0_0_20px_rgba(212,175,55,0.2)] z-20">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="text-[#D4AF37] hover:text-white text-xs font-mono uppercase"
            >
              Fechar
            </button>
          </div>
