  ...
  return (
    <div className="max-w-3xl mx-auto p-6 md:p-10 mt-8 mb-12 bg-brand-gray border-4 border-brand-neon shadow-[8px_8px_0px_var(--color-brand-neon)] relative overflow-hidden group">
      ...
      <div className="mb-10 text-center relative z-10">
        ...
        <h1 className="font-display font-black text-6xl md:text-8xl tracking-tighter uppercase mb-2 text-brand-light text-shadow-neon">
          Mapeamento Inicial
        </h1>
        <p className="text-brand-magenta font-mono font-bold text-lg uppercase tracking-widest">
          Responda para a forja neural montar seu treino perfeito.
        </p>
      </div>

      <form
        onSubmit={handleSubmit}
        className="space-y-8 bg-brand-gray border-4 border-brand-neon p-6 md:p-10 shadow-brutal-neon"
      >
        {/* Personal Info */}
        ...
        <div className="space-y-4 pt-6 border-t-2 border-brand-light/10">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {['Iniciante', 'Intermediário', 'Avançado'].map((level) => (
                  <label
                    key={level}
                    className={`cursor-pointer border-2 py-4 text-center text-xs font-bold uppercase tracking-widest transition-colors ${profile.experienceLevel === level ? 'bg-brand-neon border-brand-neon text-brand-dark shadow-brutal-neon' : 'bg-brand-dark border-brand-light/20 text-brand-muted hover:border-brand-magenta hover:text-brand-magenta'}`}
                  >
                    <input
                      type="radio"
            ...
            <div>
              <label className="block text-xs font-bold text-brand-muted uppercase tracking-widest mb-2 mt-4">
                Objetivo Principal
              </label>
              <select
                name="goal"
        ...
        <div className="space-y-4 pt-6 border-t-2 border-brand-light/10">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div>
              <label className="block text-xs font-bold text-brand-muted uppercase tracking-widest mb-2">
                Dias por semana:{' '}
                <span className="text-brand-neon text-lg ml-2">{profile.daysPerWeek}</span>
              </label>
              <input
                type="range"
                name="daysPerWeek"
            ...
            <div className="mt-4">
              <label className="block text-xs font-bold text-brand-muted uppercase tracking-widest mb-2">
                ...
                <span className="text-brand-neon text-lg ml-2">{profile.timePerWorkout}</span>
              </label>
              <input
                type="range"
                name="timePerWorkout"
