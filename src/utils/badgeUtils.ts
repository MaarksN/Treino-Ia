...
export const ALL_BADGES: Badge[] = [
  ...
  },
  {
    id: 'streak_3',
    name: 'Trio invicto',
    description: '3 treinos consecutivos',
    emoji: '🔥',
    category: 'consistency',
    unlocked: false,
  },
  ...
  },
  {
    id: 'total_100',
    name: 'Centenário',
    description: '100 treinos totais',
    emoji: '🏛️',
    category: 'consistency',
    unlocked: false,
  },
...
export function evaluateAndUnlockBadges(
  ...
  return ALL_BADGES.filter((b) => unlocked.has(b.id)).map((b) => ({
    ...b,
    unlocked: true,
    unlockedAt: Date.now(),
  }));
