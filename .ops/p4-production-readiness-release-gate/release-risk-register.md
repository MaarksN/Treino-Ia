...
| P4-R02 | Fluxo de testes completos sem relatório consolidado nesta execução local | Médio | Aberto | Engenharia | Executar `npm test` em CI com artifact de resultados e retenção de logs | 2026-05-23 |
